...
// DistinctWithField ...
func (warehouseImplement) DistinctWithField(ctx context.Context, cond interface{}, field string) ([]interface{}, error) {
	return database.WarehouseCol().Distinct(ctx, field, cond)
}
